...
//     return (
//         <div className="overflow-hidden mt-32 mx-auto px-10">
//             <div className="grid grid-cols-[70%_30%] gap-10">
//                 {/* Left Side - Menu Categories */}
//                 <div className="w-full h-auto">
//                     <div className="flex items-center justify-between">
//                         <h1 className="text-[#07143B] text-4xl font-bold">Menu Category</h1>
//                         <div className="flex items-center pr-5">
//                             <span className="text-black text-base">View All</span>
//                             <img src={Rsicon} alt="Arrow" className="w-5 h-5 ml-5" />
//                         </div>
//                     </div>
...
//                         {menuCategories.map((category) => (
//                             <div key={category.id} className="w-28 h-60 p-6 bg-[#FFFFFF66] backdrop-blur-[42px] hover:bg-orange-500 hover:rounded-2xl cursor-pointer">
//                                 <img src={category.img} alt="Icon" className="w-14 h-14 mx-auto" />
//                                 <h1 className="text-center text-[#07143B] mt-2 group-hover:text-white">{category.name}</h1>
//                                 <img src={Line1} alt="Line" className="w-8 mx-auto my-2" />
//                                 <img src={hoveredCategoryId === category.id ? RsIcon3 : Rsicon} className="w-5 h-5 mx-auto" alt="Arrow" />
//                             </div>
//                         ))}
//                     </div>
//                 </div>
...
//                 {/* Right Side - My Cart */}
//                 <div className="w-full min-w-[300px] md:min-w-[400px] h-auto p-6 bg-[#FFFFFF99] backdrop-blur-[42px] rounded-lg">
//                     <h1 className="text-[23px] font-bold text-[#07143B]">My Cart</h1>
//                     <img src={Line2} alt="Divider" className="w-full mt-5 border-[#E3E1E1]" />
//                     <div className="w-full h-auto mt-5 border-2 border-black p-4 space-y-4">
//                         {cartItems.map((cItem) => (
//                             <div key={cItem.id} className="flex items-center space-x-4">
//                                 <img src={cItem.img} className="w-20 h-20 shadow-md rounded-full" alt="Cart Item" />
//                                 <div className="flex-grow">
//                                     <p className="text-[#07143B] font-semibold">{cItem.name}</p>
//                                     <p className="text-sm text-gray-600">$7.49</p>
//                                 </div>
//                                 <img src={DelIcon} className="w-6 h-6 cursor-pointer" alt="Delete" />
//                             </div>
//                         ))}
//                     </div>
//                 </div>
